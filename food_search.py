...
MOOD_SYNONYMS: dict[str, list[str]] = {
    "がっつり": ["揚げ物", "丼", "ラーメン", "カツ", "焼肉", "ステーキ", "ハンバーグ", "唐揚げ", "大盛り", "ボリューム", "多め", "たっぷり"],
    "こってり": ["ラーメン", "揚げ物", "カレー", "チーズ", "焼肉", "脂", "こってり", "濃厚"],
    "あっさり": ["さっぱり", "そば", "うどん", "サラダ", "野菜", "おひたし", "冷奴", "少なめ", "軽食", "お茶漬け", "素麺"],
    "さっぱり": ["あっさり", "そば", "サラダ", "野菜", "酢", "冷奴", "素麺", "レモン"],
    "ヘルシー": ["野菜", "サラダ", "蒸し", "豆腐", "少なめ", "魚", "きのこ", "海藻", "玄米", "雑穀"],
    "バランス": ["定食", "主菜", "副菜", "汁物", "野菜", "バランス"],
    "軽め": ["軽食", "少なめ", "おにぎり", "サンドイッチ", "スープ", "ヨーグルト", "果物", "おやつ"],
    "重め": ["揚げ物", "丼", "ラーメン", "多め", "ボリューム"],
    "甘いもの": ["デザート", "おやつ", "ケーキ", "チョコ", "アイス", "プリン", "菓子"],
    "甘い": ["デザート", "おやつ", "ケーキ", "チョコ", "アイス", "プリン", "菓子"],
    "辛い": ["辛味", "唐辛子", "キムチ", "麻婆", "カレー", "担々"],
    "夜食": ["夜食", "カップ麺", "おにぎり", "軽食", "コンビニ"],
    "朝食": ["朝食", "グラノーラ", "パン", "トースト", "ヨーグルト", "卵", "味噌汁", "納豆"],
}
...
ルール:
- 検索語の意図（料理名・食材・調理法・食事の状況・雰囲気・量の印象など）に合う候補の番号だけを選ぶ
